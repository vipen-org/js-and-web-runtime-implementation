...
function default_getCurrentLogLevel(ctx) {
	...
	if (typeof process === "object") {
		if ("VIPEN_RUNTIME_LOG_LEVEL" in process.env) {
			current_log_level = process.env["VIPEN_RUNTIME_LOG_LEVEL"].toLowerCase()
		}
	} else if (typeof window === "object") {
		if ("VIPEN_RUNTIME_LOG_LEVEL" in window) {
			current_log_level = window.VIPEN_RUNTIME_LOG_LEVEL.toLowerCase()
		}
	}
